                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div class="card">
                                    ...
                                    <form method="POST" action="{{ route('admin.room-numbers.update', $roomNumber->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <input id="name" name="room_number" type="text"
                                                        @class(['form-control', 'is-invalid' => $errors->has('room_number')])
                                                        value="{{ old('room_number', $roomNumber->room_number) }}" />
                                                    @error('room_number')
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select" name="room_id">
                                                        ...
                                                        @foreach ($rooms as $room)
                                                            <option @selected($roomNumber->room_id == $room->id)
                                                                value="{{ $room->id }}">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select" id="input46" name="status">
                                                        <option @selected($roomNumber->status == 'available') value="available">available
                                                        </option>
                                                        <option @selected($roomNumber->status == 'occupied') value="occupied">occupied
                                                        </option>
                                                        <option @selected($roomNumber->status == 'maintenance') value="maintenance">
                                                            maintenance</option>
                                                    </select>
                                                    @error('status')
                                                        <span class="text text-danger">{{ $message }}</span>
