            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Book Area</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div class="card">
                                    ...
                                    <form method="POST" action="{{ route('admin.bookarea.store') }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <input id="name" name="title" type="text"
                                                        @class(['form-control', 'is-invalid' => $errors->has('title')]) value="{{ old('title') }}" />
                                                    @error('title')
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <input id="name" name="short_title" type="text"
                                                        @class(['form-control', 'is-invalid' => $errors->has('short_title')]) value="{{ old('short_title') }}" />
                                                    @error('short_title')
                                                        <span class="text text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <textarea @class(['form-control', 'is-invalid' => $errors->has('description')]) name="description" rows="3" placeholder="Address"></textarea>
                                                    @error('description')
                                                        <span class="text text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
